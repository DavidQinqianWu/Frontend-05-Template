...
var MyMap = /** @class */ (function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					...
					case 1:
						...
						if (
							!(
								targetPoint.x === end_.x &&
								targetPoint.y === end_.y
							)
						)
							return [3 /*break*/, 5];
						path = [];
					...
					case 2:
						if (
							!(
								targetPoint.x != start_.x ||
								targetPoint.y !== start_.y
							)
						)
							return [3 /*break*/, 4];
						// 回溯到起点 只要targetPoint 不是起点
						path.push(
							this.map[targetPoint.y * 100 + targetPoint.x]
						);
						// 让 targetPoint  = table里面记录的点的pre点
						targetPoint = this.table[
					...
					case 5:
						...
						return [
							4 /*yield*/,
							this.insertCoordinate(insertLeft, targetPoint),
						];
					case 6:
						_a.sent();
						return [
							4 /*yield*/,
							this.insertCoordinate(insertTop, targetPoint),
						];
					case 7:
						_a.sent();
						return [
							4 /*yield*/,
							this.insertCoordinate(insertRight, targetPoint),
						];
					case 8:
						_a.sent();
						return [
							4 /*yield*/,
							this.insertCoordinate(insertDown, targetPoint),
						];
					case 9:
						_a.sent();
						return [
							4 /*yield*/,
							this.insertCoordinate(insertTopLeft, targetPoint),
						];
					case 10:
						_a.sent();
						return [
							4 /*yield*/,
							this.insertCoordinate(insertTopRight, targetPoint),
						];
					case 11:
						_a.sent();
						return [
	...
	MyMap.prototype.insertCoordinate = function (
		coordinate_,
		previousCoordinate_
	) {
		return __awaiter(this, void 0, void 0, function () {
